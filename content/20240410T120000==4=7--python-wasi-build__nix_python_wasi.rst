:title: Python WASI Build
:identifier: 20240410T120000
:signature: 4=7
:date: 2024-04-10
...
.. note:: 
   ...
   I never quite finished this, but these notes might prove useful at some stage.

Previously, when setting up a development environment using the WASI build of Python with Nix, I "cheated" and just copied the result from an
