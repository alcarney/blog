...
This relies on the same mechanism that {denote:link}`20231107T123925` uses to determine a patch's hunk header.
See {ref}`20231107T123925-hunk-header` for more details.
