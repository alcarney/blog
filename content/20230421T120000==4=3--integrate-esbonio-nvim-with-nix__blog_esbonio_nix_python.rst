...
.. container:: post-teaser
   ...
   So far I've been learning how to use Nix by trying to package and define development shells for `esbonio`_ (see :doc:`here </tag/nix>` if you are interested).
...
.. details:: Example wrapper script
